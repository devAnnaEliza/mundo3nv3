...
public class CadastroBDTeste {
    ...
    private static void alterarPessoa(Scanner scanner) {
        System.out.println("Implemente a opção de alterar Pessoa Física ou Jurídica aqui.");
    }

    private static void excluirPessoa(Scanner scanner) {
        System.out.println("Implemente a opção de excluir Pessoa Física ou Jurídica aqui.");
    }

    private static void exibirPorId(Scanner scanner) {
        System.out.println("Implemente a opção de exibir por ID Pessoa Física ou Jurídica aqui.");
    }

    private static void exibirTodos() {
        System.out.println("Implemente a opção de exibir todas as pessoas aqui.");
    }
}
